...
;**************************************************************
; Version History:
; 1.00 | release:21.05.16 | PB v.5.31 | Author: Stefan Elser
; 1.01 | release:22.05.16 | PB v.5.31 | Author: Stefan Elser
; 1.02 | release:26.05.16 | PB v.5.31 | Author: Stefan Elser
...
Define takeconfig.i=0
 ...
 If ExamineDirectory(1,GetEnvironmentVariable("APPDATA") + "\SE-Development\TTDC\v.1.04\", "*.*")  
   While NextDirectoryEntry(1)
     If DirectoryEntryType(1) = #PB_DirectoryEntry_File
       If Len(DirectoryEntryName(1)) > 2
         Createprogramfile(GetEnvironmentVariable("APPDATA") + "\","SE-Development\SDC\v."+version,"SE-Development\SDC\v."+version+"\",DirectoryEntryName(1),GetEnvironmentVariable("APPDATA") + "\SE-Development\TTDC\v.1.04\"+DirectoryEntryName(1))
         Delay(60)
         DeleteFile(GetEnvironmentVariable("APPDATA") + "\SE-Development\TTDC\v.1.04\"+DirectoryEntryName(1))
         Delay(30)
         takeconfig=1
       EndIf
     EndIf
...
Enumeration ;GADGETS
  ...
  #GADGET_BUTTON_changegem
  #GADGET_BUTTON_upgradegem
...
If LoadFont(0, "Impact", 17)=0
  ...
  MessageRequester("ERROR","Couldn't load the font 'Arial - Size 17'")
  End
EndIf
If LoadFont(1, "Arial Black", 7,#PB_Font_Bold)=0
  MessageBeep_(#MB_ICONHAND)
  MessageRequester("ERROR","Couldn't load the font 'Arial - Size 7 - Bold'")
  End
EndIf
...
If LoadFont(3, "Arial Black",8, #PB_Font_Bold)=0
  MessageBeep_(#MB_ICONHAND)
  MessageRequester("ERROR","Couldn't load the font 'Courier - Size 8 - Bold'")
  End
EndIf
...
If Val(config(0))=0
  OpenWindow(#WINDOW_main,0,0,665,115+yplus,"SD Controller v." + version + " ~ "+activeprofile(loadedprofiles-1),#PB_Window_SystemMenu|#PB_Window_ScreenCentered)
Else
  OpenWindow(#WINDOW_main,Val(config(0)),Val(config(1)),665,115+yplus,"SD Controller v." + version + " ~ "+activeprofile(loadedprofiles-1),#PB_Window_SystemMenu)
EndIf
...
ButtonGadget(#GADGET_BUTTON_profiles,485,4+yplus,70,20,"PROFILES")
ButtonGadget(#GADGET_BUTTON_status,490,28+yplus,60,60,"?")
SetGadgetFont(#GADGET_BUTTON_status,FontID(3))


ButtonGadget(#GADGET_BUTTON_leave,485,92+yplus,70,20,"LEAVE")

ButtonGadget(#GADGET_BUTTON_settings,565,4+yplus,95,20,"SETTINGS >",#PB_Button_Toggle)
ButtonGadget(#GADGET_BUTTON_classes,565,26+yplus,95,20,"CLASSES >",#PB_Button_Toggle)
ButtonGadget(#GADGET_BUTTON_shop,565,48+yplus,95,20,"SHOP >",#PB_Button_Toggle)
ButtonGadget(#GADGET_BUTTON_priestcast,565,70+yplus,95,20,"PRIESTCAST >",#PB_Button_Toggle)
ButtonGadget(#GADGET_BUTTON_target,565,92+yplus,95,20,"TARGET >",#PB_Button_Toggle)
...
;******************************************
If Val(config(4))=0
  OpenWindow(#WINDOW_shop,0,0,345,465,"Shop ~ "+activeprofile(loadedprofiles-1),#PB_Window_SystemMenu|#PB_Window_ScreenCentered|#PB_Window_Tool)
Else
  OpenWindow(#WINDOW_shop,Val(config(4)),Val(config(5)),345,465,"Shop ~ "+activeprofile(loadedprofiles-1),#PB_Window_SystemMenu|#PB_Window_Tool)
EndIf
StickyWindow(#WINDOW_shop,1)
HideWindow(#WINDOW_shop,1)

FrameGadget(#GADGET_FRAME_classes,5,5,WindowWidth(#WINDOW_shop)-185,455,"CLASSES")
SetGadgetFont(#GADGET_FRAME_classes,FontID(1))
y.i=10
ButtonGadget(#GADGET_BUTTON_buysniper,10,10+y,150,25,"Buy Sniper [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buyfalconeer,10,10+y,150,25,"Buy Falconeer [10000g]")
y+40

ButtonGadget(#GADGET_BUTTON_buyassassin,10,10+y,150,25,"Buy Assassin [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buyninja,10,10+y,150,25,"Buy Ninja [10000g]")
y+40

ButtonGadget(#GADGET_BUTTON_buytrickster,10,10+y,150,25,"Buy Trickster [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buystormmage,10,10+y,150,25,"Buy Stormmage [10000g]")
y+40

ButtonGadget(#GADGET_BUTTON_buylightningmage,10,10+y,150,25,"Buy Lightningmage [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buybombermage,10,10+y,150,25,"Buy Bombermage [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buypyromancer,10,10+y,150,25,"Buy Pyromancer [10000g]")
y+40

ButtonGadget(#GADGET_BUTTON_buydeathdealer,10,10+y,150,25,"Buy Deathdealer [10000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buynecromancer,10,10+y,150,25,"Buy Necromancer [10000g]")
y+40

ButtonGadget(#GADGET_BUTTON_buymimic,10,10+y,150,25,"Buy Mimic [5000g]")
y+30
ButtonGadget(#GADGET_BUTTON_buyscout,10,10+y,150,25,"Buy Scout [5000g]")
...
FrameGadget(#GADGET_FRAME_gem,180,385,WindowWidth(#WINDOW_shop)-185,75,"GEM")
SetGadgetFont(#GADGET_FRAME_gem,FontID(1))
y=390
ButtonGadget(#GADGET_BUTTON_changegem,185,10+y,150,25,"Switch Gem")
y+30
ButtonGadget(#GADGET_BUTTON_upgradegem,185,10+y,150,25,"Upgrade Gem")
...
;TextGadget(#GADGET_TEXT_mousepos1,10,40,150,20,"Chat input position:")
;StringGadget(#GADGET_STRING_mousepos1x,120,38,70,20,config(10))
;StringGadget(#GADGET_STRING_mousepos1y,200,38,70,20,config(11))

;TextGadget(#GADGET_TEXT_showmousepos,10,15,150,20,"")
      ...
      Select EventMenu()
        ...
        Case 20:
           If GetGadgetState(#GADGET_CHECKBOX_command)=0
             Command("!gold")
           Else
             SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!gold ")
             If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
           EndIf
    ...
    Case #PB_Event_Gadget:
      ...
      Case #GADGET_BUTTON_buyassassin: 
            If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buyassasin")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buyassasin ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
       Case #GADGET_BUTTON_buyfalconeer: 
            If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buyfalconeer")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buyfalconeer ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
       Case #GADGET_BUTTON_buysniper: 
            If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buysniper")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buysniper ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
       Case #GADGET_BUTTON_buypyromancer: 
            If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buypyromancer")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buypyromancer ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
       Case #GADGET_BUTTON_buytrickster: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buytrickster")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buytrickster ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buydeathdealer: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buydeathdealer")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buydeathdealer ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buynecromancer: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buynecromancer")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buynecromancer ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buymimic: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buymimic")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buymimic ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buystormmage: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buystormmage")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buystormmage ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buylightningmage: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buylightningmage")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buylightningmage ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buyninja: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buyninja")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buyninja ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buyscout: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buyscout")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buyscout ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_buybombermage: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!buybombermage")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!buybombermage ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_upgradegem: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!upgradegem")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!upgradegem ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
        Case #GADGET_BUTTON_changegem: 
          If GetGadgetState(#GADGET_CHECKBOX_command)=0
              Command("!switchgem")
            Else
              SetGadgetText(#GADGET_STRING_Command, GetGadgetText(#GADGET_STRING_Command)+"!switchgem ")
              If GetGadgetState(#GADGET_CHECKBOX_Commandautosend)=1
                time=1
              EndIf
            EndIf
